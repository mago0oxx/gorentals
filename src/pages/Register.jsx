        ...
        <Card className="border-0 shadow-xl rounded-3xl overflow-hidden">
          ...
          <CardHeader className="text-center pt-8 pb-4">
            ...
            <CardTitle className="text-2xl">
              {step === 1 ? t('auth.welcome') : t('auth.completeProfile')}
            </CardTitle>
            <CardDescription>
              {step === 1 
                ? t('auth.loginPrompt')
                : t('auth.profilePrompt')}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-8">
            {step === 1 ? (
              ...
              <div className="space-y-6">
                <div>
                  <Label className="text-base font-medium mb-4 block">{t('auth.whatDoYouWant')}</Label>
                  <RadioGroup value={userType} onValueChange={setUserType} className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-500 text-center">{t('auth.rentDesc')}</span>
                    </Label>
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-500 text-center">{t('auth.publishDesc')}</span>
                    </Label>
                  </RadioGroup>
                </div>
